...
def stop_button(value):
    return mark_safe(f'<button class="btn btn-outline-secondary" data-bs-toggle="popover" data-bs-html="true"'
                     ...
                     f'data-bs-content="<a href=\'{reverse("buses:index")}?origin={form_stop_string(value)}\' class=\'btn btn-primary m-1\'>Origin</a> '
                     f'<a href=\'{reverse("buses:index")}?destination={form_stop_string(value)}\' class=\'btn btn-primary m-1\'>Destination</a> '
